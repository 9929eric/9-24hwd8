...
with open("tps_report.csv", "w", newline="") as csvfile:
  ...
  for employee in employees:
    writer.writerow({"first_name": employee['first_name'],"last_name": employee['last_name'],"job_title": employee['job_title'],"hire_date": employee['hire_date'],"performance_review": employee['performance_review']})
